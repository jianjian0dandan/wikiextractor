...
class Extractor():
    ...
    def load(self):
        self.__segmentor.load(os.path.join(AB_PATH, 'ltp_data/cws.model'))
        self.__postagger.load(os.path.join(AB_PATH, 'ltp_data/pos.model'))
        self.__recognizer.load(os.path.join(AB_PATH, 'ltp_data/ner.model'))
        self.__parser.load(os.path.join(AB_PATH, 'ltp_data/parser.model'))
        self.__labeller.load(os.path.join(AB_PATH, 'ltp_data/srl'))
